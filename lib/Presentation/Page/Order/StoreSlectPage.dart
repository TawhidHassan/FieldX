...
class ShopSelect extends StatefulWidget {
  ...
  const ShopSelect({Key key, this.shopId}) : super(key: key);
  @override
...
class _ShopSelectState extends State<ShopSelect> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Select Shop"),),
      body: Material(
        elevation: 30.0,
                              ...
                              SizedBox(
                                ...
                                child: ListView(
                                    ...
                                    children:  data.data.map((data) =>  Container(
                                      ...
                                      child:  InkWell(
                                        onTap: (){
                                          Navigator.pushNamed(context, ORDER_TAKE_PAGE, arguments: {
                                            'shopId':data.id,
                                            'routeId':widget.shopId
                                          });
                                        },
