...
class DpOrderMapPage extends StatefulWidget {
  @override
  _DpOrderMapPageState createState() => _DpOrderMapPageState();
}

class _DpOrderMapPageState extends State<DpOrderMapPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Order Map"),),
                      ...
                      child: SizedBox(
                        ...
                        child: ListView(
                            ...
                            children:  data.data.map((data) =>  Container(
                              ...
                              child:  InkWell(
                                  onTap: (){
                                    BlocProvider.of<ShopCubit>(context).loadStoreDetails(data.store.id,token);
                                  },
                                  child: MapRouteBottomCard(name: data.store.name,)),
                            )
                            ).toList()
                        ),
                      ),
